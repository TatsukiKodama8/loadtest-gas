...
const Metrics = Object.freeze([
    {
        ...
        queryBuilder: (t, range) => {
            const sel = buildSelector("kubernetes.io/container/cpu/limit_utilization", t.labels);
    ...
    },
    {
        ...
        queryBuilder: (t, range) => {
            const sel = buildSelector("kubernetes.io/container/memory/limit_utilization", t.labels);
            return `max_over_time(${sel}[${range}])`;
        },
    },
]);
const OutputColumns = Object.freeze({
    "stock-conversion": {
